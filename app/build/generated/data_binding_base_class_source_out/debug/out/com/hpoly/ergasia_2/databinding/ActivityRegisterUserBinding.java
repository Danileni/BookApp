...
public final class ActivityRegisterUserBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView recVoice;

  @NonNull
  public final ImageView recVoice1;
  ...
  private ActivityRegisterUserBinding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
      ...
      @NonNull ProgressBar progressBar2, @NonNull ImageView recVoice, @NonNull ImageView recVoice1,
    ...
    this.recVoice = recVoice;
    this.recVoice1 = recVoice1;
  ...
  public static ActivityRegisterUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rec_voice;
      ImageView recVoice = ViewBindings.findChildViewById(rootView, id);
      if (recVoice == null) {
        break missingId;
      }

      id = R.id.rec_voice1;
      ImageView recVoice1 = ViewBindings.findChildViewById(rootView, id);
      if (recVoice1 == null) {
        break missingId;
      }
      ...
      return new ActivityRegisterUserBinding((ConstraintLayout) rootView, button2,
          editTextTextEmailAddress2, editTextTextPassword2, editTextTextPassword3,
          editTextTextPersonName, progressBar2, recVoice, recVoice1, textView5, textView6);
    }
